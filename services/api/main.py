...
from app.runtime import files, health, metrics, research, upload  # noqa: E402
...
app = FastAPI(
    ...
    description="Deep-research agent backed by Backblaze B2 (cached pages, screenshots, reports)",
    version="0.1.0",
    lifespan=lifespan,
)
